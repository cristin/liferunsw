...
public class QBQueriesDef {

	// Applications settings
	//
	public static final String APPLICATION_ID = "7774";
	public static final String AUTH_KEY = "muRG3KueHCcSy7N";
	public static final String AUTH_SECRET = "pNvXQvEdLRkLrTD";
